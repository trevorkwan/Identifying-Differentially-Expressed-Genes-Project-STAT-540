GSAT540\_Project\_Markdown
================
Quaranteam
17/03/2021

Download the ‘GSE166992\_RAW.tar’ dataset from:
<https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE166992>

Decompress the file and there are a bunch of gz files within.

I think each patient has three files attached: a matrix file, a features
file, and a barcodes file. Each need to be loaded together when you use
the read10X
command.
